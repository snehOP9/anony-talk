  ...
  return (
    <div className="lp-root">
      ...
      <section className="lp-hero">
        <div className="lp-badge">🔒 100% Anonymous · Zero Judgment · Free Forever</div>
        <h1 className="lp-hero-title">
          Your Mind Deserves<br />
          <span className="lp-gradient-text">A Safe Space</span>
        </h1>
        <p className="lp-hero-sub">
          AnonyTalk is a mental wellness platform built for teens and young adults (ages 12–25).
          Talk to an AI, connect with a community, track your mood, and access support tools —
          all without revealing who you are.
        </p>
        <div className="lp-hero-cta">
          <Link to="/auth" className="lp-btn-solid lp-btn-lg">Start Your Journey — It's Free</Link>
      ...
      <section className="lp-cta">
        ...
        <h2 className="lp-cta-title">You Are Never Alone</h2>
        <p className="lp-cta-sub">
          Join thousands of young people who found their voice, their community,
          and their peace on AnonyTalk.
        </p>
        <div className="lp-cta-buttons">
          <Link to="/auth" className="lp-btn-solid lp-btn-lg">Create My Safe Space ✨</Link>
          <Link to="/auth" className="lp-btn-outline lp-btn-lg">👻 Join as Ghost — No Sign Up</Link>
        </div>
